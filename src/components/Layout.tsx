...
export function Navbar() {
  ...
  return (
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 md:p-6 p-4`}>
      <div className={`max-w-7xl mx-auto flex items-center justify-between transition-all duration-300 ${scrolled ? 'bg-white/5 backdrop-blur-md border border-white/10 rounded-full px-6 py-3 shadow-lg' : 'bg-transparent px-2 py-4'}`}>
        <a href="#" className="flex items-center gap-3 group">
          <svg viewBox="0 0 115 110" className="w-[46px] h-[44px] group-hover:scale-105 transition-transform shrink-0" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col pt-1">
            <span className="font-display font-bold text-xl tracking-widest text-white uppercase leading-none">Clone Yourself</span>
          </div>
        </a>
